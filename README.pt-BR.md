...
Componente web para adicionar ou remover o contraste e aumentar ou diminuir o tamanho da fonte, melhorando a experiência de usuário para todos.
...
[Acesse a documentação completa](packages/accessibility-buttons/README.md)
...
[Saiba como contribuir](https://github.com/tiagoporto/.github/blob/main/CONTRIBUTING.md).

## 🤜🤛 Doações

Este projeto foi desenvolvido no meu tempo livre. Qualquer doação é muito bem-vinda.
...
Accessibility Buttons © 2015 por Tiago Porto está sob a licença [MIT License](LICENSE).
